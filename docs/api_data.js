define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/teacher/homework/:class"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/admin/homework/:class",
    "title": "All Class Homework",
    "description": "<p>List all submission content for a specific class</p>",
    "name": "content",
    "group": "Admin",
    "version": "1.0.0",
    "permission": [
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/admin/homework/:class"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/profile/homework/:class",
    "title": "My Homework",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/profile/homework/:class"
      }
    ]
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "user",
            "description": "<p>User ID to toggle a user being an admin</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/v1/discussion/thumbnail/:submission",
    "title": "Submission Thumbnail",
    "description": "<p>Thumbnail for submission</p>",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/discussion/thumbnail/:submission"
      }
    ]
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "url",
            "description": "<p>URL to scrape or the HTML contents (or text) that should be parsed for a submission</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/discussion/submit/:class/:content"
      }
    ]
  },
  {
    "type": "post",
    "url": "/v1/discussion/verify/:submission",
    "title": "Verify Submission",
    "description": "<p>Verify that this submission is the correct one for this homework and add to discussion pool</p>",
    "name": "verify",
    "group": "Discussion",
    "version": "1.0.0",
    "permission": [
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/discussion/verify/:submission"
      }
    ]
  },
  {
  ...
  {
    "type": "get",
    "url": "/v1/messages/visualisation/:class/:content/:groupby/:limit",
    "title": "Visualisation",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "limit",
            "description": "<p>Upper block number by which to normalise results</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/messages/visualisation/:class/:content/:groupby/:limit"
      }
    ]
  },
  {
    "type": "post",
    "url": "/v1/moderate/change/:item",
    "title": "Change Moderation Status",
    "description": "<p>Change status for any item getting moderated</p>",
    "name": "moderationchange",
    "group": "Moderation",
    "version": "1.0.0",
    "permission": [
      {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>One of 'approved','denied'</p>"
          }
        ]
      }
    },
    "filename": "api/controllers/ModerationController.js",
    "groupTitle": "Moderation",
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/moderate/change/:item"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/moderate/pending",
    "title": "Pending Moderation",
    "description": "<p>Get a list of items pending moderation</p>",
    "name": "moderationlist",
    "group": "Moderation",
    "version": "1.0.0",
    "permission": [
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/moderate/pending"
      }
    ]
  },
  {
    "type": "post",
    "url": "/v1/moderate/report/:item",
    "title": "Report For Moderation",
    "description": "<p>Report any item for moderation</p>",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/moderate/report/:item"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/teacher/messages/:class?/:user?",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/teacher/messages/:class?/:user?"
      }
    ]
  },
  {
    ...
    "title": "All Messages",
    "description": "<p>List all messages for this course, only show ones from their classes.</p>",
    "name": "admin_messages",
    "group": "Profile",
    "version": "1.0.0",
    "permission": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/profile/messages/:class?"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/admin/classrooms/:class?",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/admin/classrooms/:class?"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/teacher/classrooms/:class?",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/teacher/classrooms/:class?"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/admin/students/:class?",
    "title": "All Users",
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/admin/students/:class?"
      }
    ]
  },
  {
    "type": "get",
    "url": "/v1/teacher/students/:class?",
    "title": "Users for Class",
    "description": "<p>List all users for this class</p>",
    "name": "users",
    "group": "Profile",
    "version": "1.0.0",
    "permission": [
    ...
    "sampleRequest": [
      {
        "url": "https://api.connectedacademy.io/v1/teacher/students/:class?"
      }
    ]
  }
] });
